  ...
  return (
    <div className="space-y-8">
              ...
              {filteredIcons.map((icon) => {
                ...
                return (
                  <button
                    ...
                    className="group relative flex flex-col items-center justify-center p-4 rounded-lg border border-border bg-card hover:bg-accent hover:border-primary/50 transition-all cursor-pointer"
                  >
      ...
      <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
        <DrawerContent side="bottom" overlay className="h-[40vh] border-dashed">
          <DrawerBody className="p-10 h-full">
            {selectedIcon && (
              <div className="flex gap-6 h-full justify-center">
                {/* Preview de l'icon à gauche */}
                <div className="shrink-0 h-full">
                  <div className="flex items-center justify-center p-6 border border-border rounded-lg bg-card aspect-square h-full">
                    <selectedIcon.component className="w-16 h-16" />
                  </div>
                </div>
                ...
                <div className="flex flex-col justify-center gap-2 w-2/5">
                  ...
                  <div className='grid gap-2'>
                    <h3 className="text-3xl font-semibold">{selectedIcon.name}</h3>
                    <p className="text-sm text-muted-foreground">Version {selectedIcon.version}</p>
                  </div>
